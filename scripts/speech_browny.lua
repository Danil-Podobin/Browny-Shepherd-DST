...
return {
	...
	-- Tirix specific
	ANNOUNCE_TAUNT = "Come and get me!",
	ANNOUNCE_TAUNT_COOLDOWN = "Not even going to bother trying that.",
	ANNOUNCE_TAUNT_READY = "Okay, I'm ready to make something else angry.",
	ANNOUNCE_TAUNT_FAIL = "I didn't anger anyone that time.",
	ANNOUNCE_RAGE_FULL = "I will destroy the nearest thing I see!",
	--
